            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden lg:flex items-center space-x-8">
                        <a href="#home" className="text-black hover:text-[#4f39f6] transition-colors text-sm font-medium relative group">
                            Home
                            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#4f39f6] group-hover:w-full transition-all duration-300"></span>
                        </a>
                        <a href="#book" className="text-black hover:text-[#4f39f6] transition-colors text-sm font-medium relative group">
                            Book Slot
                            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#4f39f6] group-hover:w-full transition-all duration-300"></span>
                        </a>
                        <a href="#how-it-works" className="text-black hover:text-[#4f39f6] transition-colors text-sm font-medium relative group">
                            How It Works
                            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#4f39f6] group-hover:w-full transition-all duration-300"></span>
                        </a>
                        <a href="#support" className="text-black hover:text-[#4f39f6] transition-colors text-sm font-medium relative group">
                            Support
                            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#4f39f6] group-hover:w-full transition-all duration-300"></span>
                        </a>
                    </div>
